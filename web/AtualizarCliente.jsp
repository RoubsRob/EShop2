<%-- 
    ...
    Created on : 16/11/2017, 03:47:58
    Author     : Roberta
--%>
...
<html>
    ...
    <body>
        <h1>Entre com dados do cliente <br>
        Atenção! O cpf deve permanecer o mesmo!</h1>
        
        <form action="AtualizaCliente" method="POST" onsubmit="testaForm()">
        <br>
