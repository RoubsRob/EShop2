 ...
 */
package br.com.roberta.filtros;
 ...
 * @author Roberta
 */
@WebFilter(filterName = "Verifica_logado", urlPatterns = {"/*"})
public class Verifica_logado implements Filter {
    ...
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
        ...
        if (debug) {
            log("Filtro_teste:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("Filtro_teste:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
      ...
      System.out.println("Entrou no filtro VERIFICA_LOG");
        
        if (debug) {
            log("Filtro_teste:doFilter()");
        }
        ...
        //System.out.println("EntrOUUUUU no filtro DO PROF nome " + wrappedRequest.getParameter("nome"));        
        //System.out.println("EntrOUUUUU no filtro DO PROF A nova senha É: " + wrappedRequest.getParameter("senha"));

//        Object c = wrappedRequest.getParameterNames()
...
//        System.out.println("EntrOUUUUU no filtro DO PROF APOS PROCESSO");   
//        System.out.println("EntrOUUUUU no filtro DO PROF valor da senha aqui:  " + wrappedRequest.getParameter("senha"));    
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("Filtro_teste: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("Filtro_teste(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("Filtro_teste::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("Filtro_teste::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("Filtro_teste::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("Filtro_teste::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("Filtro_teste::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
